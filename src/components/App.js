...
import hogsData from '../porkers_data'; // Ensure this file contains your hog data
import Nav from './Nav';
...
const [hogs, setHogs] = useState (hogsData);
  ...
  return (
    <div className="App">
      <h1 className="headerText">Hog Management</h1>
      ...
      <div className="ui grid">
        {filteredAndSortedHogs.length > 0 ? (
          ...
          <div className="sixteen wide column">
            ...
            <button onClick={() => setShowGreasedOnly(false)} className="ui button">Add a Hog</button>
          </div>
        )}
      </div>
    </div>
